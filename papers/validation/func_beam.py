...
if __name__ == "__main__":
    ...
    with Pool(16) as p:
        for power_beam_theory, power_beam_noise in p.map(get_3d_power, range(128)):
    ...
    np.savez(
        ...
        power_beam_theory_arr=power_beam_theory_arr,
        power_beam_noise_arr=power_beam_noise_arr,
    )
