...
class PowerSpectrum(FieldPowerSpectrum, ModelPowerSpectrum):
    ...
    **params: dict
    ...
    # ):
    #    """
    #    Run a PCA cleaning test by injecting white noise into the data,
    #    separately clean original data and injected noise,
    #    and then compare the standard deviation of the residual maps.
    #    See :func:`meer21cm.util.pca_clean` for more details.


#
#    Note that `std_weights
#
#    Parameters
#    ----------
#    sigma_N: float.
#        The standard deviation of the white noise.
#    N_fg: int.
#        The number of foreground components to be cleaned.
#    weights: array, default None.
#        The weights of the data for covariance calculation. If None, use the class attribute ``self.W_HI``.
#    mean_center: bool, default True.
#        If True, the data will be mean-centered before covariance calculation.
#    mean_center_weights: array, default None.
#        The weights for calculating mean of the data. If None, use the class attribute ``self.W_HI``.
#    ignore_nan: bool, default True.
#        If True, the nan values in the data will be ignored.
#    counts: array, default None.
#        The counts in each pixel. If None, the counts will be one across the cube.
#    seed: int, default None.
#        The seed for the random number generator. Default uses the class attribute ``self.seed``.
#    std_weights: array, default None.
#        The weights for calculation of the standard deviation.
#    """
#    pass
